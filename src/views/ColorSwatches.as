package views
{
	...
	public class ColorSwatches extends Sprite
	{
		...
		private var hairColors:Array=[0xD95858,0xF9AF48,0xD4BE01,0x2DB475,0x33ACE0,
			0x535ABA,0x865F3F,0x4E4C4C,0xCCCCCC,0xFD7DAC];
		private var skinColors:Array=[0xFFFFFF,0xFED0CB,0xFEDBC1,0xC59C70,0x736358];
		private var eyesColors:Array=[0xF97A82,0xF9AF48,0xFFFF00,0x78FB8A,
			0x7CC7FC,0x7D84FA,0x946D4C,0x818181];
		private var upperbodyColors:Array=[0xD95858,0xF9AF48,0xD4BE01,0x2DB475,0x33ACE0,
			0x535ABA,0x865F3F,0x4E4C4C,0xCCCCCC,0xFD7DAC];
		private var lowerbodyColors:Array=[0xD95858,0xF9AF48,0xD4BE01,0x2DB475,0x33ACE0,
			0x535ABA,0x865F3F,0x4E4C4C,0xCCCCCC,0xFD7DAC];
