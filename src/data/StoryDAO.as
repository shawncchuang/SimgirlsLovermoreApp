...
public class StoryDAO {
    ...
    private static function s047():Array{
        ...
        return ["com|bg_SportsBarScene","com|display_sao_casual1_center#com|music-on_ironic","spC|Phew! To tell you the truth<> I was freaking out when that guy pointed the needle at Ceil.","spC|Great team work<> Apollyon!","com|move_sao_casual1_right#com|display_ceil_work_left","spL|......","spL|I am worrying about Sirena.","spR|She'll be fine! I can tell Sirena really loves you<> Ceil!","spL|I always know that. She can be mean sometimes<> but she is warm inside!","spR|I would love to find out<> haha.","spR|Anyhow... now I think someone has some explanations to do?","com|remove_ceil_work_left#com|display_dea_casual2_left","spL|I can't say I understand the situation completely. I will try. ","spL|Sirena's boss is called SimMan. ","com|photo-on_MiaSimMan","player|He is the SMA teacher of Primero<> Rufus and two other students.","player|Lenus also learned from him the skill True Karmic Principles - the skill that reflected the deadly punch from Tyren. ","player|Other than that<> we know almost nothing about him. SimMan is a mystery to say the least. ","player|According to the document hidden in Humpty's hard disk<> SimMan created a SMA skill called À la prochaine some 20 years ago.","com|photo-off#com|photo-on_MiaAngel","player|To be exact<> À la prochaine is only a theoretical skill. Even the creator SimMan himself had never tried to put the skill in practice. ","player|In short<> it is a skill to summon the Spirit of Love to come out of the body.","player|In order to use À la prochaine<> the user must have insanely high level of SE. Then he has to release all his SE in a very short period of time<> like a hundredth of a second.  ","player|The downside is after using the divine skill the Spirit of Love will be gone for good leaving an empty body. ","player|Since it is too dangerous to try<> and almost no one possess that massive amount of SE nor the ability to release it so rapidly<> the divine skill can only stay on papers. ","com|photo-off","spL|Later on<> SimMan permanently banned the skill and hid the documentation in Humpty's hard disk.","spL|SimMan learned about the broken robot<> probably from Sirena. ","spL|Then he asked her to retrieve the damaged hard disk<> in order to avoid the secrets from leaking out during the memory recovery process. ","thR|......","spR|Well<> I guess it makes sense.","spR|How about that crazy raven motherfucker in the sewer? ","spL|I am not sure. I believe he is also one of the former Blackspears soldiers. ","spL|Somehow he is using these robotic ravens to monitor the entire island and obviously<> he wants the secrets inside the hard disk as well.","spL|Too bad Primero didn't leave us a contact number. He may know more about this man.  ","spR|Sick! This place has a limitless supply of mysteries. ","com|remove_dea_casual2_left#com|remove_sao_casual1_center#com|music-off","com|display_ceil_work_left#com|display_mia_right","shR|I said I want a long island!","spL|Sorry<> we can't serve minors here. ","spR|I am 14 and I am mature enough to handle a long island. Please? ","spL|Sorry kid<> let me get you an ice tea instead. ","shR|Nevermind! You're the KID!","spL|Huh?","com|photo-on_MiaPlay#com|music-on_sao","player|Da-da-da-da! Look at you! Onion Man!","player|The little girl flipped up Ceil's mini-skirt and revealed her cartoonish panties.  ","player|What!?","player|Remember my name from now on<> Mia!","com|photo-off#com|remove_mia_right","player|The little girl Mia ran away afterwards. ","thL|How come she knows that I'm wearing...?","com|music-off","END"]
    ...
    private static function s048():Array{
        return ["com|bg_HotelScene#com|photo-on_BarSao#com|music-on_horror","player|I want to tell you something...","player|I... I don't want to know! Just leave me alone!","player|Sao... listen... I am your mother<> Annabeth! ","player|Mom!? ","player|Primero killed your father. They used to be best friends. ","player|Primero destroyed our family. I want Justice!","player|What are you talking about!?","player|Remember! It is better to have an enemy than to have a FRIEND who's putting you down secretly.","com|photo-off#com|music-off","com|display_sao_casual1_center","thC|Phew! The same dream again...","thC|Primero killed my father?","thC|Weird as fuck...","END"]
    }

    private static function s049():Array{
        return ["com|bg_HotSpringScene","com|display_tyren_center#com|music-on_rufusbattle","spC|I am pretty sure... Lenus Lovemore used 'True Karmic Principles' to deflect my punch!","spC|And recently<> they drove Sana and Xenos out of the Temple as well. ","spC|We can't underestimate the Lovemore kids. I don't think Zack is ready to lead team Zephon<> Sir!","com|photo-on_RufusSpring","player|A huge man in red hair is sitting at the edge of a hot springs pool. A beautiful woman is next to him.  ","player|Zack is my son. He can do it. ","player|Tyren: He is still young...","com|photo-off#com|photo-on_RufusStand#com|swf-on_fxzok","player|The red-haired giant stood up abruptly. ","player|Are you challenging my judgement call<> Tyren? ","player|Tyren took a couple steps backwards.","com|photo-off#com|music-off","shC|NO SIR!!!!","com|move_tyren_left#com|display_rufus3_right","spR|You said that Lovemore kid used the neutral skill to deflect your punch...","spR|Punch me as hard as you can. ","thL|Last time I used not even half of my power... ","shL|YES SIR!!!!","com|remove_tyren_left#com|display_gorilla_left","com|music-on_danger#com|swf-on_fxboom","com|photo-on_RufusPunch","player|Rufus and Tyren exchanged a punch. ","player|GGGYYAAAHHH!","player|Tyren's arm is snapped like a dried twig!","com|photo-off","com|remove_gorilla_left#com|move_rufus3_center","spC|Consider this a punishment for your weakness. ","spC|Before you get your ass in the hospital<> tell Vodka and Shinichi I'll visit them soon.","com|music-off","END"]
    }

    private static function s050():Array{
        return ["com|bg_LovemoreMansionScene","com|photo-on_RobotFix","player|Lenus had fashioned a new Humpty - all it needed was the drive. Lenus placed it in the center of the chest.","player|I thought the drive was the robot's brain.","player|No. Any computer can have a brain. Humpty needed a heart. A soul.","player|All the other parts can be fixed but if the hard drive is damaged<> Humpty will be gone for good.","com|photo-off#com|display_lenus_work_center","spC|Should be up and running soon. It will take some time to reboot the system.","thC|......","spC|Do you believe in love at first sight?","spC|I know it is very silly. Ceil told you my story. I was in love with this drive-thru girl. ","spC|We texted a lot but the first time we went out... you know... she died in a car accident. ","spC|It doesn't make any sense at all<> but I just can't get her out of my head completely. ","com|photo-on_MiaGhost#com|music-on_precioustime","player|Whenever I go<> I can still feel her presence near me. ","player|You know... I spend most of my time with computers. It was the first time I had such a strong feeling towards a human being.  ","player|......","player|What if she is my twin flame? ","com|photo-off","player|Answer 1: I believe in love at first sight too.","player|Answer 2: Lenus<> you are thinking too much. You just need to know more people. ","spC|I know.","spC|By the way<> have you met that special someone? ","player|......","com|music-off","END"]
    }

    private static function s051():Array{

        return ["com|bg_SkyNight","com|photo-on_DanceLimo#com|music-on_liberty","player|Dea: Cheers everyone!","player|All Lovemore girls: Cheers!","player|Klaire: Seriously<> when was the last time we all went to a party together? ","player|Ceil: Maybe back in grade school? Your graduation dinner?","player|Sirena: Ceil<> are you sure Tomoru was there? ","player|Tomoru: Hey! I was there! ","player|Dea: Just chill<> honeys. ","com|photo-off#com|bg_Ballroom","player|The SSCC Gala Dinner","com|display_sao_party_center","shC|Woo-hoo!","spC|But where are our ladies?","com|move_sao_party_left#com|display_lenus_party_right","spR|They are coming... late as usual. ","spL|......","spL|Oh shit! Zack is here. ","com|remove_lenus_party_right#com|display_zack_party_right","spR|What's up<> Apollyons?","spL|My blood pressure. Beacuse of you.","spR|I know you love me!","com|remove_sao_party_left#com|move_zack_party_center","spC|Hey Captain Apollyon<> $$$! ","player|I've heard that you are playing for team Zephon. ","spC|Of course! It's my father's team. ","spC|I've a reminder for you: only the two top teams can make it to the finals. ","spC|I hope you guys can make it that far. ","player|answer 1 We will see.","player|answer 2 I will see you in the finals!","spC|Good. Now please excuse me. ","com|move_zack_party_right#com|display_sao_party_left","spL|Yo<> Captain! The ladies are here. ","com|remove_zack_party_right#com|remove_sao_party_left","player|The dinner began. Some people got on the stage to say something about SSCC. We had some great food and fine wine prepared by the SMA chef Tian. We had some laughs and toasts...","player|And finally after the dinner<> people started to dance. ","player|I was looking at one very special person the whole night. I think I found the one... ","choice|twinflame","player|I wanted to invite @@@ to dance with me.","com|display_sao_party_center#com|music-off","spC|Hey $$$<> I don't know man...","spC|I think I have a serious BIG fucking crush on @@@...","spC|I shall dance with @@@. Wish me luck buddy!","player|(Damn<> Sao!!!! Not @@@!!!!)","player|We are falling with the same person. I want to say something. A flashback comes to my mind at the same time.","com|photo-on_MiaKid","player|About 10 years ago we had a school picnic. We met a mad dog running towards us. Everyone ran away. I fell down.","player|One kid returned and saved me. He threw rocks at the mad dog like crazy and finally drove it away. Sao is my bro.","com|photo-off","player|I gave Sao a thumbs up. Good luck buddy!","player|Sao went on and invited @@@ to dance. @@@ gracefully accepted. I watched them dance for a bit.","player|Time to get some fresh air.","com|bg_SkyNight","com|photo-on_DancePool","player|I went outside of the ballroom. A water fountain caught my attention. ","player|The statue in the middle is called Shamhat<> the Goddess of Freedom and Love. ","com|photo-off#com|photo-on_DanceCrystal","player|I reached into my pocket and took the little black crystal ball out. It was given by Dea at the Temple. She said it is a storage for the Spirit of Love. ","player|I don't think I need this. I throw it into the fountain. ","com|photo-off","com|display_@@@_party_center","spC|I figured I'd find you here.","player|Thought you were dancing with Sao.","spC|The way Sao dances? He won't notice I'm gone for another five minutes.","spC|Anyway... what did you do? I just saw you throwing something into the fountain. ","player|I told @@@.","shC|What!? What a waste! It was made from an ancient meteorite...","player|@@@ is taking off the shoes...","spC|Want to help me rescue a black crystal ball out of a fountain?","player|I kicked off my shoes. We both went into the water fountain. ","spC|The water is cold!","player|We looked for the black crystal ball a bit.","com|music-on_dance","player|Then<> they are playing the good old wedding music inside the ballroom...","player|The mood is right.","spC|I don't think we can find it. Well...","spC|May I?","player|Dance here? I don't know about it...","com|twin-photo-on_Dance@@@","player|I don't do ball room dancing<> but here I am with @@@.","player|And we manage to take a selfie picture pretending to dance in the water.","player|What I thought was the worst night of my life turned out to be the best. ","player|......","com|music-off","END"]
