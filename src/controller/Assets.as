package controller
{
	...
	public class Assets
	{
		private static var subclassObj:Object={
			//"CharacterDesignScene":new BgRegular(),
			//"MainScene":new BgMainScene(),
			//"MainSceneNight":new BgMainSceneNight(),
			//"GameTitle":new BgGameTitle(),
			//"Tarotreading":new BgTarotreading(),
			//"AirplaneScene":new BgAirplaneScene(),
			//"AirportScene":new BgAirportScene(),
			//"HotelScene":new BgHotelScene(),
			//"FitnessClubScene":new BgFitnessClubScene(),
			//"bluesky":new BgBlueSky(),
			//"Shutterstock":new Shutterstock(),
			//"ShutterstockConverted":new ShutterstockConverted(),
			//"ShutterstockFrameAni":new ShutterstockFrameAni(),
			//"MuseumScene":new BgMuseumScene(),
			//"BeachScene":new BgBeachScene(),
			//"NightClubScene":new BgNightClubScene(),
			//"ArenaScene":new BgArena(),
			//"AcademyScene":new BgAcademyScene(),
			//"SpiritTempleScene":new BgTempleScene(),
			//"PoliceStationScene":new BgPoliceStationScene(),
			//"CasinoScene":new BgCasino(),
			//"LovemoreMansionScene":new BgLovemoreMansion(),
			//"ShoppingCentreScene":new BgShoppingCentreScene(),
			//"CinemaScene":new BgCinema(),
			//"PierScene":new BgPierScene(),
			//"LoungeScene":new BgLoungeScene(),
			//"RestaurantScene":new BgRestaurantScene(),
			//"ParkScene":new BgParkScene(),
			//"ThemedParkScene":new BgThemedParkScene(),
			//"HotSpringScene":new BgHotSpringScene(),
			//"SportsBarScene":new BgSportsBar(),
			//"BankScene":new BgBank(),
			//"PrivateIslandScene":new BgPrivateIsland(),
			//"GardenScene":new BgGarden(),
			//"BlackMarketScene":new BgBlackMarket(),
			//"ChangingRoomScene":new BgChangingRoom(),
			"sirena":new Sirena(),
			"sao":new Sao(),
			"zack":new Zack(),
			"tomoru":new Tomoru(),
			...
			//"ChangeFormationScene":new BgRegular(),
			//"MenuScene":new BgRegular(),
			//"ProfileScene":new BgRegular(),
			"PanelProfile":new PanelProfile(),
			"PanelAssets":new PanelAssets(),
			"PanelSkills":new PanelSkills(),
			//"FoundSomeScene":new BgRegular(),
